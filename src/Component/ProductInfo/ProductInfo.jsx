...
export default function ProductInfo() {
    ...
    // TabToggle.array.forEach((tab,index) => {
        ...
        <Navbar/>
            <div className="Product-Full-Detail">
                <div className="Product-Image col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                        <SwiperSlide><img src={Citrine} /></SwiperSlide>
                        <SwiperSlide><img src={Ring4} /></SwiperSlide>
                        <SwiperSlide><img src={Ring7} /></SwiperSlide>
                        <SwiperSlide><img src={Ring8} /></SwiperSlide>
                    </Swiper>
                </div>
            ...
            <div className="Info-Tabs">
                <div className="Tab-Head">
                    <span className="Tab-Toggle is-active">Description</span>
                    <span className="Tab-Toggle">Additional Information</span>
                    <span className="Tab-Toggle">Review</span>
